...
public class _1_Binary_tree_implementation {
	...
	private Node root;
	public _1_Binary_tree_implementation(){
	...
	public static void main(String[] args) {
		_1_Binary_tree_implementation bt=new _1_Binary_tree_implementation();
		...
		System.out.println(bt.height());	//consider single node height is 0
